...
export default function Layout({ children }: { children: React.ReactNode }) {
  return (
    <div className="flex-1 w-full flex flex-col gap-20 items-center min-h-screen">
      <header className="w-full">
        <nav className="w-full flex justify-center border-b border-b-foreground/10 h-16">
          <div className="w-full px-3 md:px-0 max-w-5xl md:max-w-6xl flex justify-between items-center p-3 text-sm">
            <svg className="fill-[#baff66] h-8" id="Layer_1" data-name="Layer 1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1267.06 344.39">
      ...
      <main className="flex-1 w-full max-w-5xl md:max-w-6xl px-5 md:px-0">{children}</main>
